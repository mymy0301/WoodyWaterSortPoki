    ...
    execute: function () {
      ...
      _export("SpinPopup", SpinPopup = (_dec = ccclass('SpinPopup'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Prefab), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Node), _dec9 = property(Label), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(AnimationComponent), _dec13 = property(Node), _dec(_class = (_class2 = (_temp = class SpinPopup extends (_crd && BasePopup === void 0 ? (_reportPossibleCrUseOfBasePopup({
        ...
        showPoup_ShowView_Finished() {
          ...
          if (this.arrItemSpins.length > 0) {
            ...
            for (let i = 0; i < (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              let item = instantiate(this.getItemRewardReceivePrefab((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
              }), localConfig) : localConfig).instance.arrSpinRewardDataInfos[i].items[0].itemShopType));
              item.parent = this.contentGroup;
              item.setRotationFromEuler(new Vec3(0, 0, i * 45));
              let itemSpin = item.getComponent(_crd && ItemSpin === void 0 ? (_reportPossibleCrUseOfItemSpin({
                error: Error()
              }), ItemSpin) : ItemSpin);
              itemSpin.initItem(i, (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
              }), localConfig) : localConfig).instance.arrSpinRewardDataInfos[i].items[0].value, (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
              }), localConfig) : localConfig).instance.arrSpinRewardDataInfos[i].items[0].itemShopType);
        ...
        setSpinStart() {
          let self = this;
          let indexRotate = 0;
          let angleStart = this.spinGroup.eulerAngles.z % 360; // console.log("angleStart:"+angleStart);
          ...
          let angleTarget = this.indexTarget * 45 + (_crd && lodash === void 0 ? (_reportPossibleCrUseOflodash({
            error: Error()
          ...
          this.tweenRotate = tween(this.spinGroup).call(() => {
            ...
            onUpdate(target, ratio) {
              ...
              let currIndexRotate = Math.floor(self.spinGroup.angle / 45);
