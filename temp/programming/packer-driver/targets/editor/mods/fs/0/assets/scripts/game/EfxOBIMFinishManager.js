System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Prefab, Vec3, clientEvent, Constants, AudioManager2, localConfig, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, EfxOBIMFinishManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "2ba2evkWRZGDbUCWEbUybYO", "EfxOBIMFinishManager", undefined);
      ...
      _export("EfxOBIMFinishManager", EfxOBIMFinishManager = (_dec = ccclass('EfxOBIMFinishManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = (_temp = class EfxOBIMFinishManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        onEnable() {
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constants) : Constants).SHOW_EFX_OBIM_FINSIHED, this.showEfxOBIMFinished, this);
        }
        ...
        showEfxOBIMFinished(posWorld, scale) {
...
//# sourceMappingURL=EfxOBIMFinishManager.js.map