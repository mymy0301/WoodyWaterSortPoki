    ...
    execute: function () {
      ...
      _export("ItemTube", ItemTube = (_dec = ccclass('ItemTube'), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(Mask), _dec5 = property(Sprite), _dec6 = property(Button), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(_crd && ItemWater === void 0 ? (_reportPossibleCrUseOfItemWater({
        ...
        initItemTube(_tubeX, _tubeY, _arrIndexColors) {
          ...
          let countIndexColor_SameHeadIndexColor = this.getCountIndexColor_SameHeadIndexColor(_arrIndexColors); // console.log("countIndexColor_SameHeadIndexColor:",countIndexColor_SameHeadIndexColor);

          for (let i = 0; i < this.arrItemWaters.length; i++) {
            let waterState = (_crd && WATER_STATE === void 0 ? (_reportPossibleCrUseOfWATER_STATE({
              error: Error()
        ...
        initMagicItemTube(_magicBInfo, _tubeX, _tubeY, _arrIndexColors, _arrWaterLocks) {
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            if (this.magicBInfo.OBIM && this.magicBInfo.OBIM.length > 0) {
              let magicOBIMInfo = this.magicBInfo.OBIM[0];
        ...
        initItemWaterScale() {
          let itemTubePolygonConfig = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          ...
          for (let i = itemTubePolygonConfig.arrPoints.length - 2; i >= 0; i--) {
            let point = itemTubePolygonConfig.arrPoints[i];
            this.arrPoints.push(new Vec2(-point.x, point.y));
          }

          for (let i = 0; i < this.arrItemWaters.length; i++) {
            let pointCheckTOP = new Vec2(0, (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
            }), localConfig) : localConfig).instance.getItemWater_TOP_PosY(i));
            let pointCheckBOTTOM = new Vec2(0, (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
            }), localConfig) : localConfig).instance.getItemWater_PosY(i));
            let intersectionsTOP = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).getPolygonIntersection(pointCheckTOP, 0, this.arrPoints);
            let scaleTOP = 1; // console.log(intersectionsTOP);
            ...
            let intersectionsBOTTOM = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).getPolygonIntersection(pointCheckBOTTOM, 0, this.arrPoints);
            let scaleBOTTOM = 1; // console.log(intersectionsBOTTOM);
            ...
            let itemTubeConfig = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
            ...
            let scaleInitTop = itemTubeConfig.arrScaleInitTops[i];
        ...
        drawPolygon() {
          ...
          for (let i = 0; i < arrPoints.length; i++) {
            let newPoint = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).rotatePointBack(arrPoints[i], new Vec2(0, 0), 44);
          ...
          let pointCheck = new Vec2(0, 95); // let newPointCheck:Vec2 = Utils.rotatePointBack(pointCheck,new Vec2(0,0),44);
          ...
          this.graphics.stroke();
          let intersections = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).getPolygonIntersection(pointCheck, 0, arrRotatePoints); // console.log(intersections);

          if (intersections.length >= 2) {
            let scaleX = Math.abs(intersections[1].x - intersections[0].x) / 126;
            let posX = (intersections[1].x - intersections[0].x) / 2; // console.log(scaleX,posX);
        ...
        setMoveToTarget(itemTubeTarget, indexStep, posTarget, isRight, indexStepON, countWaterOFF) {
          ...
          let angleRotateTube = itemTubeConfig.arrRotateConfigs[indexStep];
          ...
          let posY = itemTubeConfig.arrMoveConfigs[indexStep]; // console.log("posY"+posY);

          let scaleY = itemTubeConfig.arrScaleConfigs[indexStep]; // console.log("scaleY"+scaleY);

          let scaleWater = itemTubeConfig.arrScaleWaterConfigs[indexStep];
          ...
          this.tweenAllItemRotate = tween(this.groupAllItemRotate).to(this.TIME_MOVE_TO_TARGET, {
            ...
            onUpdate: (target, ratio) => {
              let angleRotate = this.groupAllItemRotate.eulerAngles.z; // console.log("angleRotate:"+angleRotate);

              let posY = this.groupAllItemMove.position.y;
              let scaleY = this.groupAllItemMove.scale.y; // console.log("posY:"+angleRotate);
              ...
              for (let i = 0; i < this.arrItemWaters.length; i++) {
                ...
                let scaleBOTTOM = 1;
                let posBOTTOM_x = 0; // console.log(intersectionsBOTTOM);
                ...
                let scaleWaterY = (scaleWater - 1) * ratio + 1;
        ...
        setMoveToTarget_Finished(itemTubeTarget, indexStep, isRight, indexStepON, countWaterOFF) {
          let indexStepOFF = indexStep + 1; // console.log("setMoveToTarget_Finished:",countWaterOFF);
        ...
        setTubeOFF_StepbyStep(itemTubeTarget, indexStepOFF, isRight, indexStepON, countWaterOFF, isStartOFF) {
          ...
          let angleRotateTube = itemTubeConfig.arrRotateConfigs[indexStepOFF];
          ...
          let posY = itemTubeConfig.arrMoveConfigs[indexStepOFF];
          let scaleY = itemTubeConfig.arrScaleConfigs[indexStepOFF];
          let scaleWater = itemTubeConfig.arrScaleWaterConfigs[indexStepOFF];
          let scaleWaterPrev = itemTubeConfig.arrScaleWaterConfigs[indexStepOFF - 1]; // console.log("scaleWater:",scaleWater,scaleWaterPrev);
              ...
              for (let i = 0; i < this.arrItemWaters.length; i++) {
                ...
                if (i == 4 - indexStepOFF) {
                  pointCheckTOP.y = ((1 - ratio) * (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                    ...
                    error: Error()
                  }), localConfig) : localConfig).instance.getItemWater_PosY(i)) * scaleY + posY;
                } else {
                ...
                let scaleWaterY = (scaleWater - scaleWaterPrev) * ratio + scaleWaterPrev; // console.log("scaleWaterY:",scaleWaterY);
          ...
          this.tweenAllItemRotate = tween(this.groupAllItemRotate).to(this.TIME_MOVE_BACK, {
            ...
            onUpdate: (target, ratio) => {
              ...
              for (let i = 0; i < this.arrItemWaters.length; i++) {
                ...
                let scaleWaterY = (1 - ratio) * (scaleWater - 1) + 1;
                this.arrItemWaters[i].updateMoveToTarget(scaleTOP, posTOP_x, scaleBOTTOM, posBOTTOM_x, scaleWaterY);
              }
            },
            onComplete: () => {
        ...
        setTubeMoveBack_Finished() {
          ...
          let isWaterUnlock = false;
          let countItemWater_SameHeadIndexColor_LOCK = this.getCountItemWater_SameHeadIndexColor_LOCK(); // console.log("countItemWater_SameHeadIndexColor_LOCK:"+countItemWater_SameHeadIndexColor_LOCK);
        ...
        setStart_WaterON(indexWater, countWaterON) {
          ...
          if (this.isOnStepbyStep) {
            ...
            let indexONNow = countItemWater_Available - countWaterON - 1;
        ...
        setTubeON_StepbyStep(indexWater, countWaterON) {
          ...
          let itemWaterON = this.arrItemWaters[indexWater];
          ...
          this.tweenProgressON = tween(this.progressBar_waterON).to(this.TIME_POUR_INDDEX, {
            ...
            onUpdate: (target, ratio) => {
              ...
              if (intersectionsTOP.length >= 2) {
                let scaleTOP = Math.abs(intersectionsTOP[intersectionsTOP.length - 1].x - intersectionsTOP[0].x) / (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                  error: Error()
                }), localConfig) : localConfig).instance.ITEMWATER_WIDTH;
        ...
        onTouchMoveItemTube(event) {
          ...
          let posCheck = this.node.parent.getComponent(UITransform).convertToNodeSpaceAR(new Vec3(locationUI_Check.x, locationUI_Check.y));
        ...
        setUnselect_ItemTube(isPlaySound = true) {
        ...
        checkTube_Finished() {
          let checkIndexColor = this.arrItemWaters[0].indexColor;
        ...
        getCountItemWater_SameHeadIndexColor() {
          ...
          let headIndexColor = this.getHeadIndexColor();
          let countItemWater_SameHeadIndexColor = 0;
        ...
        getCountIndexColor_SameHeadIndexColor(arrIndexColors) {
          ...
          let countIndexColor_SameHeadIndexColor = 0;
          let headIndexColor = arrIndexColors[arrIndexColors.length - 1];
        ...
        getCountItemWater_ON_Available() {
          let countItemWater_Avaliable = this.getCount_ItemWater_Available();
        ...
        setShuffle() {
          let arrShuffleIndexs = [];
          let arrIndexColors_Temp2 = [];
          let arrWaterStates_Temp2 = [];
          ...
          let arrIndexColors_Temp = (_crd && lodash === void 0 ? (_reportPossibleCrUseOflodash({
            error: Error()
          }), lodash) : lodash).cloneDeep(arrIndexColors_Temp2);
          let arrWaterStates_Temp = (_crd && lodash === void 0 ? (_reportPossibleCrUseOflodash({
            error: Error()
          ...
          this.tweenShuffle = tween(this.groupTube).to(0.05, {
            ...
            for (let i = 0; i < arrShuffleIndexs.length; i++) {
              ...
              if (this.arrItemWaters[i].waterState == (_crd && WATER_STATE === void 0 ? (_reportPossibleCrUseOfWATER_STATE({
                ...
                if (arrWaterStates_Temp[arrShuffleIndexs[i]] == (_crd && WATER_STATE === void 0 ? (_reportPossibleCrUseOfWATER_STATE({
                  error: Error()
                }), WATER_STATE) : WATER_STATE).NONE) {
                  this.arrItemWaters[i].setWaterUnlock();
                  (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
                    ...
                    error: Error()
                  }), Constants) : Constants).SHOW_EFX_QUESTION, new Vec3(this.node.position.x, -270 + i * 110 + this.node.position.y + 55, this.node.position.z), (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                    error: Error()
                  }), localConfig) : localConfig).instance.scaleTube);
                }
              }
