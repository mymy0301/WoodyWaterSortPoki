  ...
  return {
    ...
    execute: function () {
      ...
      _export("TubeRacePopup", TubeRacePopup = (_dec = ccclass('TubeRacePopup'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(_crd && BoxRaceRewardInfoGroup === void 0 ? (_reportPossibleCrUseOfBoxRaceRewardInfoGroup({
        ...
        showInfo() {
          let countTime = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
        ...
        showPoup_ShowView_Finished() {
          ...
          if (this.isFinddingOpponent) {
            ...
            for (let i = 0; i < this.arrPlayerOpponents.length; i++) {
              let timeFindding = 0.5 + (_crd && lodash === void 0 ? (_reportPossibleCrUseOflodash({
                error: Error()
            ...
            for (let i = 0; i < this.arrPlayerOpponents.length; i++) {
              this.arrPlayerOpponents[i].initPlayer((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
        ...
        setAllPlayerRace_MoveToTarget_Finished(isFinddingOpponent = false) {
          ...
          let arrPlayerRaceScores = [];
          let myPlayer = new (_crd && PlayerRaceScore === void 0 ? (_reportPossibleCrUseOfPlayerRaceScore({
            error: Error()
          ...
          for (let i = 0; i < this.arrPlayerOpponents.length; i++) {
            let playerOpponent = new (_crd && PlayerRaceScore === void 0 ? (_reportPossibleCrUseOfPlayerRaceScore({
              error: Error()
            }), PlayerRaceScore) : PlayerRaceScore)();
