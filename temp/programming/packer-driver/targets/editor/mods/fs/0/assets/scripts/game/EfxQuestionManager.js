System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Prefab, Vec3, clientEvent, Constants, localConfig, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, EfxQuestionManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "b4035m49ypIzYaMwuTrR3I4", "EfxQuestionManager", undefined);
      ...
      _export("EfxQuestionManager", EfxQuestionManager = (_dec = ccclass('EfxQuestionManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = (_temp = class EfxQuestionManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        onEnable() {
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constants) : Constants).SHOW_EFX_QUESTION, this.showEfxQuestion, this);
        }
        ...
        showEfxQuestion(posWorld, scale) {
...
//# sourceMappingURL=EfxQuestionManager.js.map