      ...
      _export("DailyTaskQuestGroup", DailyTaskQuestGroup = (_dec = ccclass('DailyTaskQuestGroup'), _dec2 = property(_crd && ItemDailyQuestBoxReward === void 0 ? (_reportPossibleCrUseOfItemDailyQuestBoxReward({
        ...
        initQuests() {
          ...
          for (let i = 0; i < (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            let item = instantiate(this.itemDailyQuestPrefab);
            item.setParent(this.contentGroup);
            let itemDailyQuest = item.getComponent(_crd && ItemDailyQuest === void 0 ? (_reportPossibleCrUseOfItemDailyQuest({
              error: Error()
            ...
            let progressValue = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
          ...
          for (let i = 0; i < this.arrItemDailyQuests.length; i++) {
            let itemDailyQuest = this.arrItemDailyQuests[i];
        ...
        showInfo() {
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            for (let i = 0; i < (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              let questDataInfo = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
            ...
            for (let i = 0; i < this.arrBoxRewards.length; i++) {
              let boxValue = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
              }), localConfig) : localConfig).instance.getDailyQuest_BoxRewadValue_byIndexBox(this.arrBoxRewards[i].indexBoxReward); // console.log("boxValue",boxValue);

              if (boxValue <= countAchievement) {
                this.currIndexBoxReward = this.arrBoxRewards[i].indexBoxReward; // console.log("this.currIndexBoxReward",this.currIndexBoxReward);
        ...
        setProgressAchievement_toTarget() {
          ...
          this.tweenProgressAchievement = tween(this.achivementProgress).to(0.3, {
            ...
            onUpdate: (target, ratio) => {
              let countAchievement = Math.floor(ratio * this.countAchievementTarget);
        ...
        showClaimBoxReward() {
          let groupRewardDataInfo = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
