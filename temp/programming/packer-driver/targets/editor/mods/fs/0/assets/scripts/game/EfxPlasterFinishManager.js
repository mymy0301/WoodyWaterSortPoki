System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Prefab, Vec3, clientEvent, Constants, localConfig, AudioManager2, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, EfxPlasterFinishManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "601b4RXEmtKupeXHMJIXpiq", "EfxPlasterFinishManager", undefined);
      ...
      _export("EfxPlasterFinishManager", EfxPlasterFinishManager = (_dec = ccclass('EfxPlasterFinishManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = (_temp = class EfxPlasterFinishManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        onEnable() {
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constants) : Constants).SHOW_EFX_PLASTER_FINSIHED, this.showEfxPlasterFinished, this);
        }
...
//# sourceMappingURL=EfxPlasterFinishManager.js.map