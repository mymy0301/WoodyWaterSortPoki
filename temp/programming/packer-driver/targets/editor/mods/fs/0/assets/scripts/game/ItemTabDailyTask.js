System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ec6bf9mYAxFqZ+MFzqtv3KM", "ItemTabDailyTask", undefined);
       ...
       * Name = ItemTabDailyTask
       * DateTime = Mon Oct 14 2024 11:27:30 GMT+0700 (Indochina Time)
       * Author = MoonMoon246
       * FileBasename = ItemTabDailyTask.ts
       * FileBasenameNoExtension = ItemTabDailyTask
       * URL = db://assets/scripts/game/ItemTabDailyTask.ts
       * ManualUrl = https://docs.cocos.com/creator/3.4/manual/en/
       *
       */

      _export("ItemTabDailyTask", ItemTabDailyTask = (_dec = ccclass('ItemTabDailyTask'), _dec2 = property({
        type: Enum(_crd && DAILYTASK_TYPE === void 0 ? (_reportPossibleCrUseOfDAILYTASK_TYPE({
          error: Error()
        }), DAILYTASK_TYPE) : DAILYTASK_TYPE)
      }), _dec3 = property(Button), _dec4 = property(Sprite), _dec5 = property(SpriteFrame), _dec6 = property(SpriteFrame), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = (_temp = class ItemTabDailyTask extends Component {
        constructor(...args) {
          super(...args);
        ...
        onEnable() {
          ...
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constants) : Constants).TABDAILYTASK_UPDATE, this.showTab, this);
        }
        ...
        touchTab() {
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constants) : Constants).TOUCH_TABDAILYTASK, this.tabType);
        }

        showTab(currTab) {
          // console.log("showTab:"+this.tabType,currTab);
        ...
        initializer: function () {
          return (_crd && DAILYTASK_TYPE === void 0 ? (_reportPossibleCrUseOfDAILYTASK_TYPE({
            error: Error()
...
//# sourceMappingURL=ItemTabDailyTask.js.map