System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Button, Component, Node, Constants, clientEvent, localConfig, CountDownToNextTime, AudioManager2, LogEventManager, PokiSDKManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, ItemShopFree;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "779ad7/v3lNBqQhB1JIgmaS", "ItemShopFree", undefined);
      ...
      _export("ItemShopFree", ItemShopFree = (_dec = ccclass('ItemShopFree'), _dec2 = property(Button), _dec3 = property(Node), _dec4 = property(_crd && CountDownToNextTime === void 0 ? (_reportPossibleCrUseOfCountDownToNextTime({
        error: Error()
      }), CountDownToNextTime) : CountDownToNextTime), _dec5 = property(Node), _dec(_class = (_class2 = (_temp = class ItemShopFree extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "countDownToNextTime", _descriptor3, this);
        ...
        showInfo() {
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            error: Error()
          }), localConfig) : localConfig).instance.SHOP_FREE_NEXT_TIME) {
            this.btnClaim.node.active = false;
            this.objNextTime.active = true;
            this.countDownToNextTime.initCountDownTime((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
            }), localConfig) : localConfig).instance.shop_free_lastTime + (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
              ...
              this.setCountDownToNextTimeFinished();
            });
          } else {
        ...
        touchClaim() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("shopitemfree", "shoppopup"); // FBInstantManager.instance.Show_RewardedVideoAsync("shoppopup","shopitemfree",(err,success)=>{
          //     if(err){
          //     }else{
          ...
          (_crd && PokiSDKManager === void 0 ? (_reportPossibleCrUseOfPokiSDKManager({
            error: Error()
          }), PokiSDKManager) : PokiSDKManager).instance.Show_RewardedVideoAsync("shoppopup", "shopitemfree", (err, success) => {
            if (err) {} else {
              ...
              (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
                ...
                error: Error()
              }), Constants) : Constants).SHOW_ADDCOIN, 100);
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("currency", "coin", 100, "shop", "watchad");
              (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
              }), localConfig) : localConfig).instance.setShopFreeLastTime();
              this.countDownToNextTime.initCountDownTime((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
              }), localConfig) : localConfig).instance.SHOP_FREE_NEXT_TIME, () => {
                this.setCountDownToNextTimeFinished();
        ...
        writable: true,
        initializer: null
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "countDownToNextTime", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
...
//# sourceMappingURL=ItemShopFree.js.map