        ...
        showGroup() {
          ...
          if (this.arrItemTournaments.length > 0) {
            ...
            for (let i = 0; i < (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              let itemTournament = item.getComponent(_crd && ItemTournament === void 0 ? (_reportPossibleCrUseOfItemTournament({
                error: Error()
              }), ItemTournament) : ItemTournament);
              itemTournament.init(i, (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
