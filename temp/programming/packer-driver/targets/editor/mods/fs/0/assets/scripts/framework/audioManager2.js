    ...
    execute: function () {
      ...
      _export("AudioManager2", AudioManager2 = (_dec = ccclass('AudioManager2'), _dec2 = property(AudioSource), _dec(_class = (_class2 = (_temp = _class3 = class AudioManager2 extends Component {
        ...
        playSound_showItemReward() {
          ...
          let rd = (_crd && lodash === void 0 ? (_reportPossibleCrUseOflodash({
            error: Error()
        ...
        playClay() {
          ...
          let path = 'audio/sound/clay_break_v2'; // console.log(path);
        ...
        playCurrtain() {
          ...
          let path = 'audio/sound/curtain'; // console.log(path);
