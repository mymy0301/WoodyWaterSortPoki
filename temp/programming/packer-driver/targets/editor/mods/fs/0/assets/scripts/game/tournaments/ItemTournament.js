      ...
      _export("ItemTournament", ItemTournament = (_dec = ccclass('ItemTournament'), _dec2 = property(UIOpacity), _dec3 = property(Node), _dec4 = property(Sprite), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(_crd && CountDownToNextTime_Tournament === void 0 ? (_reportPossibleCrUseOfCountDownToNextTime_Tournament({
        ...
        init(_index, _leaderboarDataInfo) {
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            let arrListLeaderboard_Ranks = []; // for (let i = 0; i < 1; i++) {
        ...
        showGroup() {
          ...
          let delayTime = this.index * 0.15 + 0.2;
        ...
        receiveListRankLeaderboard() {
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            this.showPlayers();
            let arrItemRankInfos = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
            }), localConfig) : localConfig).instance.mapLeaderBoard_ItemRankInfos.get(this.leaderboarDataInfo._id);
            let indeMyRank = arrItemRankInfos.findIndex(item => item.isMyRank == true);

            if (indeMyRank > -1) {} else {
              let myItemRankInfo = new (_crd && ItemRankInfo === void 0 ? (_reportPossibleCrUseOfItemRankInfo({
                error: Error()
            ...
            for (let i = 0; i < this.arrPlayers.length; i++) {
              let itemRankInfo = arrItemRankInfos[i];
        ...
        loadBackground() {
          let pathIcon = "tournament/" + this.leaderboarDataInfo.type + "_2";
