System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Button, AudioManager2, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, menu, requireComponent, disallowMultiple, btnAdapter;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "35510LXfeJHT5NktpRL7IoG", "btnAdapter", undefined);
      ...
      _export("btnAdapter", btnAdapter = (_dec = ccclass("btnAdapter"), _dec2 = menu('自定义组件/btnAdapter'), _dec3 = requireComponent(Button), _dec4 = property({
        ...
        start() {
          ...
          this.node.on('click', () => {
            ...
            if (this.isPlaySound) (_crd && AudioManager2 === void 0 ? (_reportPossibleCrUseOfAudioManager({
              error: Error()
            }), AudioManager2) : AudioManager2).instance.playSound(this.clickSoundName);
          });
        } // update (dt) {},
