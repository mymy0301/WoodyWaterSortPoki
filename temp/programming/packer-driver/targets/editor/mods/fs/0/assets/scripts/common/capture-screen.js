System.register(["cc"], function (_export, _context) {
  ...
  function toB64(arrayBuffer, RTex, width, height) {
    ...
    const ctx = canvas.getContext('2d'); // console.log(canvas.width);
