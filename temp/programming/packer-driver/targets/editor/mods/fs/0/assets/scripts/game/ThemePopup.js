        ...
        showTab() {
          ...
          if (this.currThemeType == (_crd && THEME_TYPE === void 0 ? (_reportPossibleCrUseOfTHEME_TYPE({
            ...
            for (let i = 0; i < (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              let item = instantiate(this.itemThemePrefab);
              item.setParent(this.contentGroup);
              let itemTheme = item.getComponent(_crd && ItemTheme === void 0 ? (_reportPossibleCrUseOfItemTheme({
                error: Error()
              }), ItemTheme) : ItemTheme);
            ...
            for (let i = 0; i < (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
            }), localConfig) : localConfig).instance.arrSkinInfos.length; i++) {
              let item = instantiate(this.itemThemePrefab);
              item.setParent(this.contentGroup);
              let itemTheme = item.getComponent(_crd && ItemTheme === void 0 ? (_reportPossibleCrUseOfItemTheme({
                error: Error()
              ...
              itemTheme.initInfo((_crd && THEME_TYPE === void 0 ? (_reportPossibleCrUseOfTHEME_TYPE({
                ...
                error: Error()
              }), localConfig) : localConfig).instance.arrSkinInfos[i].id);
            }
          }
        }
