System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Prefab, Vec3, Constants, clientEvent, localConfig, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, EfxClayFinishManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "2f3eaIh199CVbmEvczRH1Od", "EfxClayFinishManager", undefined);
      ...
      _export("EfxClayFinishManager", EfxClayFinishManager = (_dec = ccclass('EfxClayFinishManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = (_temp = class EfxClayFinishManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        onEnable() {
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constants) : Constants).SHOW_EFX_CLAY_FINSIHED, this.showEfxClayFinished, this);
        }
        ...
        showEfxClayFinished(posWorld, scale) {
          console.log("showEfxClayFinished", posWorld, scale); // AudioManager2.instance.playClay();
...
//# sourceMappingURL=EfxClayFinishManager.js.map