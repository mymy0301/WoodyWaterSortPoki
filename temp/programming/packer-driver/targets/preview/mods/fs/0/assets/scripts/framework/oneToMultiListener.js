System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, error, _decorator, _dec, _class, _class2, _temp, _crd, ccclass, oneToMultiListener;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "53e7aORrC5Hdp57kZwnQGGl", "oneToMultiListener", undefined);

      ({
        ccclass
      } = _decorator);

      _export("oneToMultiListener", oneToMultiListener = (_dec = ccclass("oneToMultiListener"), _dec(_class = (_temp = _class2 = class oneToMultiListener {
...
//# sourceMappingURL=oneToMultiListener.js.map