    ...
    execute: function () {
      ...
      _export("DailyChallengePopup", DailyChallengePopup = (_dec = ccclass('DailyChallengePopup'), _dec2 = property(Label), _dec3 = property(Button), _dec4 = property(Sprite), _dec5 = property(Button), _dec6 = property(Sprite), _dec7 = property(Node), _dec8 = property(ProgressBar), _dec9 = property(Label), _dec10 = property(_crd && ItemDailyChallengeBox === void 0 ? (_reportPossibleCrUseOfItemDailyChallengeBox({
        ...
        touchPrev() {
          ...
          var prevMonth = this.currMonth - 1;
          var prevYear = this.currYear;
        ...
        initCalendarGroup(year, month) {
          ...
          for (var i = 0; i < this.countDayOfMonth; i++) {
            var item = instantiate(this.itemDailyChallengePrefab);
            item.setParent(this.contentCalendarGroup);
            var itemDay = item.getComponent(_crd && ItemDailyChallenge === void 0 ? (_reportPossibleCrUseOfItemDailyChallenge({
              error: Error()
        ...
        initBox(countDayOfMonth, countDayOfMonth_Finished) {
          var infoMonthReward = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          ...
          var infoMonth = new (_crd && InfoMonth === void 0 ? (_reportPossibleCrUseOfInfoMonth({
            error: Error()
          }), InfoMonth) : InfoMonth)(this.currMonth, this.currYear);

          for (var i = 0; i < this.arrItemDailyChallengeBox.length; i++) {
        ...
        setDailyChallengeFinished_step5() {
          ...
          var progressValue = this.countDayOfMonth_Finished / this.countDayOfMonth; // console.log("progressValue",progressValue);
