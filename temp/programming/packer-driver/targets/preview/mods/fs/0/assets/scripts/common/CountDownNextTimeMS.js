System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Label, Utils, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, CountDownNextTimeMS;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "3cb39YKFElNFLPsAdO/nCPb", "CountDownNextTimeMS", undefined);
      ...
      _export("CountDownNextTimeMS", CountDownNextTimeMS = (_dec = ccclass('CountDownNextTimeMS'), _dec2 = property(Label), _dec(_class = (_class2 = (_temp = class CountDownNextTimeMS extends Component {
        constructor() {
          super(...arguments);
        ...
        initCountDownTime(_time, _callback) {
          ...
          this.txtCountDownTime.string = "" + (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).getTimeStrByS_2(this.countTime);
...
//# sourceMappingURL=CountDownNextTimeMS.js.map