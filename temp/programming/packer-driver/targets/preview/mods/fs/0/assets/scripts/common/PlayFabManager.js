    ...
    execute: function () {
      ...
      _export("PlayFabManager", PlayFabManager = (_dec = ccclass('PlayFabManager'), _dec(_class = (_temp = _class2 = class PlayFabManager extends Component {
        ...
        GetInfoAccountCallback(result, error) {
          ...
          var displayName = (_crd && FBInstantManager === void 0 ? (_reportPossibleCrUseOfFBInstantManager({
            error: Error()
          ...
          var avatarURL = (_crd && FBInstantManager === void 0 ? (_reportPossibleCrUseOfFBInstantManager({
            error: Error()
