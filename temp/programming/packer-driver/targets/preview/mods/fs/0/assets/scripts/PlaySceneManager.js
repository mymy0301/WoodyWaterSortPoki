    ...
    execute: function () {
      ...
      _export("PlaySceneManager", PlaySceneManager = (_dec = ccclass('PlaySceneManager'), _dec2 = property(_crd && MenuManager === void 0 ? (_reportPossibleCrUseOfMenuManager({
        ...
        showWinPopup(level) {
          ...
          if (this.winPopup) {
            ...
            (_crd && resourceUtil === void 0 ? (_reportPossibleCrUseOfresourceUtil({
              ...
              var uiPopup = instantiate(uiPrefab);
        ...
        showEfxFireWorks() {
          ...
          for (var index = 0; index < this.arrEfxFireWorks.length; index++) {
