System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Button, Component, localConfig, clientEvent, Constants, SHOP_PACK_TYPE, FBInstantManager, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, ButtonVIPManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "5b2e9QxAxBEJY7YQUqLl+6k", "ButtonVIPManager", undefined);
      ...
      _export("ButtonVIPManager", ButtonVIPManager = (_dec = ccclass('ButtonVIPManager'), _dec2 = property(Button), _dec(_class = (_class2 = (_temp = class ButtonVIPManager extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "btnVIP", _descriptor, this);
        }
        ...
        showInfo() {
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
          ...
          } else if ((_crd && FBInstantManager === void 0 ? (_reportPossibleCrUseOfFBInstantManager({
            error: Error()
            ...
            error: Error()
          }), SHOP_PACK_TYPE) : SHOP_PACK_TYPE).VIP_3)) || (_crd && FBInstantManager === void 0 ? (_reportPossibleCrUseOfFBInstantManager({
            error: Error()
          }), FBInstantManager) : FBInstantManager).instance.checkHaveIAPPack_byProductID((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          }), localConfig) : localConfig).instance.getIAP_PackID_bShopPackType((_crd && SHOP_PACK_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_PACK_TYPE({
            error: Error()
          }), SHOP_PACK_TYPE) : SHOP_PACK_TYPE).VIP_7)) || (_crd && FBInstantManager === void 0 ? (_reportPossibleCrUseOfFBInstantManager({
            error: Error()
          }), FBInstantManager) : FBInstantManager).instance.checkHaveIAPPack_byProductID((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          }), localConfig) : localConfig).instance.getIAP_PackID_bShopPackType((_crd && SHOP_PACK_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_PACK_TYPE({
        ...
        touchVIP() {
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constants) : Constants).SHOW_VIP_POPUP);
        }

      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "btnVIP", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=ButtonVIPManager.js.map