      ...
      _export("LoadSceneManager", LoadSceneManager = (_dec = ccclass('LoadSceneManager'), _dec2 = property(ProgressBar), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(UIOpacity), _dec7 = property(Node), _dec8 = property(UIOpacity), _dec(_class = (_class2 = (_temp = class LoadSceneManager extends Component {
        ...
        start() {
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            var w = view.getFrameSize().width;
            var h = view.getFrameSize().height;
        ...
        readDataLevel_Challenge() {
          (_crd && resourceUtil === void 0 ? (_reportPossibleCrUseOfresourceUtil({
            ...
            // console.log(this.indexLevel,content);
            var strRows = content.split("|");
            var strRow2 = strRows[1]; // console.log(strRow2);

            var strRow2Data = strRow2.split(";"); // console.log(strRow2Data);
            ...
            for (var _i = 2; _i < strRow2Data.length; _i++) {
              str2 += strRow2Data[_i] + ";";
            }

            str2 += strRows[2];
            var newContent = str1 + "|" + str2; // console.log(this.indexLevel,newContent);
            ...
            if (this.indexLevel > (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              for (var _i2 = 0; _i2 < (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
              }), localConfig) : localConfig).instance.WATER_MAX_CHALLENGE_LEVEL; _i2++) {
                str += this.mapLevelStr.get(_i2 + 1);
              } // console.log(str);
        ...
        setNextScene() {
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            var arrLeaderboard_contextIDs = [];
            var worldContextID = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
          ...
          var self = this; // let currProgress = this.loadingProgressBar.progress;
