      ...
      _export("ItemShopPack", ItemShopPack = (_dec = ccclass('ItemShopPack'), _dec2 = property({
        ...
        touchBuy() {
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            var _packID = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
            }), localConfig) : localConfig).instance.getIAP_PackID_bShopPackType(this.shopPackType);

            var valueIAP = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
            }), localConfig) : localConfig).instance.getValuePriceIAPPack_byProductID(_packID);
            (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
              error: Error()
            }), LogEventManager) : LogEventManager).instance.logEventIAP("" + _packID, _packID, valueIAP);
            (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
              error: Error()
        ...
        buyIAP_Success() {
          ...
          for (var i = 0; i < shopDataInfo.items.length; i++) {
            var itemShopDataInfo = shopDataInfo.items[i]; // if(itemShopDataInfo.itemShopType == SHOP_ITEM_TYPE.TICKET_GOLD){
