System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Camera, Component, Label, RichText, Sprite, localConfig, FBInstantManager, Utils, captureNode, getBase64, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, ShareContextPopup;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "d8020lVnhBJJ4dr2eVIrxcQ", "ShareContextPopup", undefined);
       ...
       * Name = ShareContextPopup
       * DateTime = Wed Dec 04 2024 17:04:33 GMT+0700 (Indochina Time)
       * Author = MoonMoon246
       * FileBasename = ShareContextPopup.ts
       * FileBasenameNoExtension = ShareContextPopup
       * URL = db://assets/scripts/game/share/ShareContextPopup.ts
       * ManualUrl = https://docs.cocos.com/creator/3.4/manual/en/
       *
       */

      _export("ShareContextPopup", ShareContextPopup = (_dec = ccclass('ShareContextPopup'), _dec2 = property(Camera), _dec3 = property(RichText), _dec4 = property(Label), _dec5 = property(Sprite), _dec(_class = (_class2 = (_temp = class ShareContextPopup extends Component {
        constructor() {
          super(...arguments);
        ...
        showShareContextPopup(level, cb) {
        ...
        captureNode_Context(cb) {
          ...
          (_crd && captureNode === void 0 ? (_reportPossibleCrUseOfcaptureNode({
            ...
            var base64 = (_crd && getBase64 === void 0 ? (_reportPossibleCrUseOfgetBase({
              error: Error()
            }), getBase64) : getBase64)(this.nodeCamera, 800, 450);
...
//# sourceMappingURL=ShareContextPopup.js.map