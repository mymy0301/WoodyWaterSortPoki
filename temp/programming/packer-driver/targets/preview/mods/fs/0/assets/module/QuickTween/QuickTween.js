  ...
  return {
    ...
    execute: function () {
      ...
      Node.prototype.qtWorldPositionX = function (to, duration, opts) {
        var startPos = this.worldPosition;
        return tween(this).to(duration, {
      ...
      Node.prototype.qtPunchPosition = function (punch, duration, opts) {
        ...
        var vibrato = (_opts$vibrato = opts === null || opts === void 0 ? void 0 : opts.vibrato) !== null && _opts$vibrato !== void 0 ? _opts$vibrato : 3;
        var elasticity = (_opts$elasticity = opts === null || opts === void 0 ? void 0 : opts.elasticity) !== null && _opts$elasticity !== void 0 ? _opts$elasticity : 0.5;
        var {
          tos,
          durations
        ...
        var punchTween = tween(this);
        tos.forEach((to, index) => {
          var d = durations[index];
          var tweenOpts;
      ...
      Node.prototype.qtPunchRotation = function (punch, duration, opts) {
        ...
        var vibrato = (_opts$vibrato2 = opts === null || opts === void 0 ? void 0 : opts.vibrato) !== null && _opts$vibrato2 !== void 0 ? _opts$vibrato2 : 3;
        var elasticity = (_opts$elasticity2 = opts === null || opts === void 0 ? void 0 : opts.elasticity) !== null && _opts$elasticity2 !== void 0 ? _opts$elasticity2 : 0.5;
        var {
          tos,
          durations
        } = (_crd && calcPunchData === void 0 ? (_reportPossibleCrUseOfcalcPunchData({
      ...
      Node.prototype.qtPunchScale = function (punch, duration, opts) {
        ...
        var vibrato = (_opts$vibrato3 = opts === null || opts === void 0 ? void 0 : opts.vibrato) !== null && _opts$vibrato3 !== void 0 ? _opts$vibrato3 : 3;
        var elasticity = (_opts$elasticity3 = opts === null || opts === void 0 ? void 0 : opts.elasticity) !== null && _opts$elasticity3 !== void 0 ? _opts$elasticity3 : 0.5;
        var {
          tos,
          durations
        } = (_crd && calcPunchData === void 0 ? (_reportPossibleCrUseOfcalcPunchData({
      ...
      Node.prototype.qtJumpPosition = function (to, jumpHeight, jumpNum, duration, opts) {
        var tweenPos = new Vec3();
        var jumpTween = tween(this);
        var totalNum = jumpNum * 2;
        this.jumpY = 0;
        var startPosY = 0;
        var yUpTween = tween().to(duration / totalNum, {
          jumpY: jumpHeight
        }, {
          onStart: target => {
        ...
        this.jumpOffsetY = 0;
        var offsetY = 0;
        var offsetYTween = tween().to(duration, {
          ...
          onUpdate: (target, ratio) => {
            var interpOffsetY = easing.quadOut(ratio) * offsetY;
            tweenPos.set(target.position);
      ...
      Node.prototype.qtShakePosition = function (strength, duration, opts) {
        ...
        var vibrato = (_opts$vibrato4 = opts === null || opts === void 0 ? void 0 : opts.vibrato) !== null && _opts$vibrato4 !== void 0 ? _opts$vibrato4 : 10;
        var randomness = (_opts$randomness = opts === null || opts === void 0 ? void 0 : opts.randomness) !== null && _opts$randomness !== void 0 ? _opts$randomness : 90;
        var fadeOut = (_opts$fadeOut = opts === null || opts === void 0 ? void 0 : opts.fadeOut) !== null && _opts$fadeOut !== void 0 ? _opts$fadeOut : true;
        var toStrength;
      ...
      Node.prototype.qtShakeRotation = function (strength, duration, opts) {
        ...
        var vibrato = (_opts$vibrato5 = opts === null || opts === void 0 ? void 0 : opts.vibrato) !== null && _opts$vibrato5 !== void 0 ? _opts$vibrato5 : 10;
        var randomness = (_opts$randomness2 = opts === null || opts === void 0 ? void 0 : opts.randomness) !== null && _opts$randomness2 !== void 0 ? _opts$randomness2 : 90;
        var fadeOut = (_opts$fadeOut2 = opts === null || opts === void 0 ? void 0 : opts.fadeOut) !== null && _opts$fadeOut2 !== void 0 ? _opts$fadeOut2 : true;
        var toStrength;
        var vectorBased = false;
      ...
      Node.prototype.qtShakeScale = function (strength, duration, opts) {
        ...
        var vibrato = (_opts$vibrato6 = opts === null || opts === void 0 ? void 0 : opts.vibrato) !== null && _opts$vibrato6 !== void 0 ? _opts$vibrato6 : 10;
        var randomness = (_opts$randomness3 = opts === null || opts === void 0 ? void 0 : opts.randomness) !== null && _opts$randomness3 !== void 0 ? _opts$randomness3 : 90;
        var fadeOut = (_opts$fadeOut3 = opts === null || opts === void 0 ? void 0 : opts.fadeOut) !== null && _opts$fadeOut3 !== void 0 ? _opts$fadeOut3 : true;
        var toStrength;
        var vectorBased = false;
      ...
      Sprite.prototype.qtOpacity = function (to, duration, opts) {
        var startColor = this.color.clone();
        ...
        return tween(this).to(duration, {
          ...
          onUpdate: (target, ratio) => {
            ...
            var lerpA = startColor.a + (to - startColor.a) * ratio;
      ...
      Camera.prototype.qtShakePosition = function (strength, duration, opts) {
        ...
        var vibrato = (_opts$vibrato7 = opts === null || opts === void 0 ? void 0 : opts.vibrato) !== null && _opts$vibrato7 !== void 0 ? _opts$vibrato7 : 10;
        var randomness = (_opts$randomness4 = opts === null || opts === void 0 ? void 0 : opts.randomness) !== null && _opts$randomness4 !== void 0 ? _opts$randomness4 : 90;
        var fadeOut = (_opts$fadeOut4 = opts === null || opts === void 0 ? void 0 : opts.fadeOut) !== null && _opts$fadeOut4 !== void 0 ? _opts$fadeOut4 : true;
        var toStrength;
        var vectorBased = false;
        ...
        var shakeTween = tween(this.node);
        tos.forEach((to, index) => {
          var d = durations[index];
          var tweenOpts;
