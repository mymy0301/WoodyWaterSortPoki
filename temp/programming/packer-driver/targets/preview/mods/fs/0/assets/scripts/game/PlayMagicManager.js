      ...
      _export("PlayMagicManager", PlayMagicManager = (_dec = ccclass('PlayMagicManager'), _dec2 = property(Node), _dec3 = property(Widget), _dec4 = property(_crd && BackGroundGameManager === void 0 ? (_reportPossibleCrUseOfBackGroundGameManager({
        ...
        setReplay() {
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            var indexDay = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
        ...
        preloadLevelChallenge(indexLevelChallenge) {
          ...
          this.infoGroupNormal.active = true;
          this.lockScene.active = true;
          var levelLoadData = indexLevelChallenge;
        ...
        preloadLevelTournament() {
          ...
          var levelLoadData = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
        ...
        initAllTubes() {
          for (var i = 0; i < (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            var item = instantiate(this.tubePrefab);
            item.setParent(this.groupAllTubes);
            var itemTube = item.getComponent(_crd && ItemTube === void 0 ? (_reportPossibleCrUseOfItemTube({
              error: Error()
            }), ItemTube) : ItemTube);
            var indexX = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
            }), localConfig) : localConfig).instance.currMagicLevelConfigInfo.B[i].indexX;
            var indexY = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
            }), localConfig) : localConfig).instance.currMagicLevelConfigInfo.B[i].indexY;
            var arrIndexColors = [];
            var arrWaterVisibles = [];
            var magicBInfo = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
        ...
        selectTubeItem(itemTube) {
          ...
          if (this.lastItemTubeSelect == null) {
            ...
            var countTubeTarget_ItemWater_Avaliable = itemTube.getCount_ItemWater_Available();
            ...
            if (countTubeTarget_ItemWater_Avaliable < 4 && (this.lastItemTubeSelect.getHeadIndexColor() == itemTube.getHeadIndexColor() || countTubeTarget_ItemWater_Avaliable == 0)) {
              ...
              var isAddScore = true;
              var isCombo = true;
              var countItem_Available = this.lastItemTubeSelect.getCountItemWater_SameHeadIndexColor();
              var countItem_ON_Available = itemTube.getCountItemWater_ON_Available();
              ...
              var countTubeLast_ItemWater_Avaiable = this.lastItemTubeSelect.getCount_ItemWater_Available();
              var indexStep = 4 - countTubeLast_ItemWater_Avaiable; // console.log("indexStep",indexStep);
              ...
              var posLastTube = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
              }), localConfig) : localConfig).instance.getMagicPosTube_byXY((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
              }), localConfig) : localConfig).instance.currMagicLevelConfigInfo, this.lastItemTubeSelect.tubeX, this.lastItemTubeSelect.tubeY);
              var posTarget = new Vec3(posTube.x - posLastTube.x, posTube.y + 282 - posLastTube.y, 0); // console.log(posTarget);

              var indexStepON = countTubeTarget_ItemWater_Avaliable; // console.log("countItem_Available:"+countItem_Available);
              ...
              if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                ...
                if (isAddScore) {
                  this.scheduleOnce(() => {
                    var scoreValue = 10 * this.comboGroup.getComboValue();
        ...
        setTubeMoveBack_Finished() {
          ...
          var isShowButtonBooster = true;

          for (var i = 0; i < this.arrItemTubes.length; i++) {
        ...
        setTubeDone(posBottleFinished) {
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            var scoreValue = 100 * this.comboGroup.getComboValue();
            this.infoGroupTournament.setAddScore(scoreValue);
          } else if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          }), localConfig) : localConfig).instance.currGameMode == (_crd && GAME_MODE === void 0 ? (_reportPossibleCrUseOfGAME_MODE({
            ...
            var _scoreValue = 100 * this.comboGroup.getComboValue();

            this.infoGroupWithFriend.setAddScore(_scoreValue);
          }
        ...
        setUseBooster_Undo() {
          ...
          if (this.arrUndo_Infos.length > 0) {
            var undoLevelDataInfo = this.arrUndo_Infos[this.arrUndo_Infos.length - 1];

            for (var i = 0; i < undoLevelDataInfo.B.length; i++) {
              var arrIndexColors = [];
              var arrWaterVisibles = [];

              for (var j = 0; j < undoLevelDataInfo.B[i].C.length; j++) {
        ...
        addUndo_Info() {
          var levelDataInfo = new (_crd && MagicLevelDataInfo === void 0 ? (_reportPossibleCrUseOfMagicLevelDataInfo({
            error: Error()
          }), MagicLevelDataInfo) : MagicLevelDataInfo)();

          for (var i = 0; i < this.arrItemTubes.length; i++) {
            var itemTube = this.arrItemTubes[i];
            ...
            var magicBInfo = new (_crd && MagicBInfo === void 0 ? (_reportPossibleCrUseOfMagicBInfo({
              error: Error()
            ...
            for (var j = 0; j < 4; j++) {
              var magicCInfo = new (_crd && MagicCInfo === void 0 ? (_reportPossibleCrUseOfMagicCInfo({
                error: Error()
        ...
        setUseBooster_Suggest() {
          ...
          for (var i = 1; i < this.arrTubeSuggests_Temp.length; i++) {
          ...
          var tubeSuggest = arrTubeSuggests[(_crd && lodash === void 0 ? (_reportPossibleCrUseOflodash({
            error: Error()
          }), lodash) : lodash).random(0, arrTubeSuggests.length)];
          var tube1 = this.arrItemTubes[tubeSuggest.tube_index_1];
          var tube2 = this.arrItemTubes[tubeSuggest.tube_index_2];
          this.addUndo_Info();
          var isRight = true;
          ...
          var countTubeTarget_ItemWater_Avaliable = tube2.getCount_ItemWater_Available();
          var countItem_Available = tube1.getCountItemWater_SameHeadIndexColor();
          var countItem_ON_Available = tube2.getCountItemWater_ON_Available();
          ...
          var countTubeLast_ItemWater_Avaiable = tube1.getCount_ItemWater_Available();
          var indexStep = 4 - countTubeLast_ItemWater_Avaiable; // console.log("indexStep",indexStep);
        ...
        findAll_Suggest_Available() {
          ...
          for (var i = 0; i < this.arrItemTubes.length; i++) {
            for (var j = 0; j < this.arrItemTubes.length; j++) {
              if (this.checkTube_Suggest_Available(i, j)) {
                var tubeSuggest = new TubeSuggest();
                tubeSuggest.tube_index_1 = i;
                tubeSuggest.tube_index_2 = j;
                var countItem_Available_Tube_1 = this.arrItemTubes[i].getCountItemWater_SameHeadIndexColor();
                var countItem_SameHeadIndexColor_Tube_2 = this.arrItemTubes[j].getCountItemWater_SameHeadIndexColor();
        ...
        checkTube_Suggest_Available(tube_index_1, tube_index_2) {
          ...
          var headIndexColor_Bottle_1 = this.arrItemTubes[tube_index_1].getHeadIndexColor();
          var headIndexColor_Bottle_2 = this.arrItemTubes[tube_index_2].getHeadIndexColor();
          ...
          if (headIndexColor_Bottle_1 == headIndexColor_Bottle_2) {
            ...
            var countItem_OFF_Available = this.arrItemTubes[tube_index_1].getCountItemWater_SameHeadIndexColor();
            var countItem_ON_Available = this.arrItemTubes[tube_index_2].getCountItemWater_ON_Available();
        ...
        showNoMovesGroup() {
          ...
          var children = this.groupAllTubes.children.slice(); // clone để tránh thay đổi khi move
        ...
        setNoMoves_Touch_PlayOn() {
          ...
          var children = this.noMovesGroupAllTubes.children.slice(); // clone để tránh thay đổi khi move
        ...
        setNoMoves_Touch_GiveUp() {
          ...
          var rewardCoin = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
        ...
        showButtonBoosterAddCol_Available() {
          ...
          var _loop = function _loop(i) {
            var arrItemTubes_byTubeY = _this.arrItemTubes.filter(itemTube => itemTube.tubeY == i);
        ...
        setUseBooster_AddCol() {
          ...
          var indexAddColY = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          }), localConfig) : localConfig).instance.currMagicLevelConfigInfo.maxRow - 1;
          var maxTubebyY = 0;
          var arrItemTubes_byTubeY = this.arrItemTubes.filter(itemTube => itemTube.tubeY == indexAddColY);
          maxTubebyY = arrItemTubes_byTubeY.length; // console.log(indexAddColY,maxTubebyY);

          var _loop2 = function _loop2(i) {
            var arrItemTubes_byTubeY = _this2.arrItemTubes.filter(itemTube => itemTube.tubeY == i); // console.log(i,arrItemTubes_byTubeY.length);
          ...
          for (var i = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          ...
          var newMagicTubeInfo = new (_crd && MagicBInfo === void 0 ? (_reportPossibleCrUseOfMagicBInfo({
            error: Error()
          }), MagicBInfo) : MagicBInfo)();
          newMagicTubeInfo.indexY = indexAddColY;
          var countTubebyY = this.arrItemTubes.filter(itemTube => itemTube.tubeY == indexAddColY).length;
          ...
          for (var _i = 0; _i < this.arrItemTubes.length; _i++) {
            this.arrItemTubes[_i].updateMagicPos();
          }
        ...
        setUseBooster_AddCol_Now() {
          ...
          var _loop3 = function _loop3(i) {
            var arrItemTubes_byTubeY = _this3.arrItemTubes.filter(itemTube => itemTube.tubeY == i); // console.log(i,arrItemTubes_byTubeY.length);
          ...
          for (var _i2 = 0; _i2 < this.arrItemTubes.length; _i2++) {
            this.arrItemTubes[_i2].updateMagicPos();
          }
        ...
        touchShuffleCancel() {
          ...
          var children = this.shuffleGroupAllTubes.children.slice(); // clone để tránh thay đổi khi move
        ...
        initTutorial_Level1() {
          ...
          if (this.tutLevel) {
            ...
            (_crd && resourceUtil === void 0 ? (_reportPossibleCrUseOfresourceUtil({
              ...
              var tutlevel1Prefab = instantiate(uiPrefab);
        ...
        */
        ...
        checkTutLevel2_TutTubes(indexTube) {
          var indexHeadColor_Selected = this.arrItemTubes[indexTube].getHeadIndexColor();

          for (var i = 0; i < this.arrItemTubes.length; i++) {
            if (i != indexTube) {
              var indexHeadColor = this.arrItemTubes[i].getHeadIndexColor();
              var countWaterInBottle = this.arrItemTubes[i].getCount_ItemWater_Available();
              var isCorrect = true;
        ...
        setWinTournament() {
          ...
          var score = this.infoGroupTournament.scoreValue;
          var leaderBoardMyScore = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          ...
          (_crd && resourceUtil === void 0 ? (_reportPossibleCrUseOfresourceUtil({
            ...
            var timePlay = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
        ...
        setWinTournamentPageHost() {
          var score = this.infoGroupTournamentPageHost.scoreValue;
          (_crd && FBInstantManager === void 0 ? (_reportPossibleCrUseOfFBInstantManager({
            error: Error()
        ...
        setWinWithFriend() {
          var score = this.infoGroupWithFriend.scoreValue;
