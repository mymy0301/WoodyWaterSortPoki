    ...
    execute: function () {
      ...
      _export("ItemMasterPass", ItemMasterPass = (_dec = ccclass('ItemMasterPass'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Button), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Button), _dec13 = property(Node), _dec14 = property(Node), _dec(_class = (_class2 = (_temp = class ItemMasterPass extends (_crd && ItemScrollView === void 0 ? (_reportPossibleCrUseOfItemScrollView({
        ...
        init(_indexPass) {
          ...
          var itemFree = instantiate(this.getItemPrefabbyShopItemType(this.passRewardDataInfo.items[0].itemShopType));
          itemFree.parent = this.nodeItemFree;
          var itemFreeReward = itemFree.getComponent(_crd && ItemRewardPass === void 0 ? (_reportPossibleCrUseOfItemRewardPass({
            error: Error()
          ...
          var itemPass = instantiate(this.getItemPrefabbyShopItemType(this.passRewardDataInfo.itemsPass[0].itemShopType));
          itemPass.parent = this.nodeItemPass;
          var itemPassReward = itemPass.getComponent(_crd && ItemRewardPass === void 0 ? (_reportPossibleCrUseOfItemRewardPass({
            error: Error()
          }), ItemRewardPass) : ItemRewardPass);
        ...
        showItemRewardClaimed(isPass, rewardDataInfo) {
          var item = instantiate(this.getItemPrefabbyShopItemType(rewardDataInfo.itemShopType));
          ...
          var itemRewardPass = item.getComponent(_crd && ItemRewardPass === void 0 ? (_reportPossibleCrUseOfItemRewardPass({
            error: Error()
          }), ItemRewardPass) : ItemRewardPass);
