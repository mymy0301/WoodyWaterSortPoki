System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Button, instantiate, Label, Node, Prefab, sp, tween, UIOpacity, Vec3, BOOSTER_TYPE, Constants, SHOP_ITEM_TYPE, localConfig, BasePopup, AudioManager2, clientEvent, ItemRewardReceive, LogEventManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _temp, _crd, ccclass, property, TubeRaceWinPopup;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ItemRewardReceive = _unresolved_7.ItemRewardReceive;
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "9b9f3CJs1VF0ahr5YWqaUhl", "TubeRaceWinPopup", undefined);
      ...
      _export("TubeRaceWinPopup", TubeRaceWinPopup = (_dec = ccclass('TubeRaceWinPopup'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(sp.Skeleton), _dec6 = property(Button), _dec7 = property(Node), _dec8 = property(UIOpacity), _dec9 = property(Button), _dec10 = property(Node), _dec11 = property(UIOpacity), _dec(_class = (_class2 = (_temp = class TubeRaceWinPopup extends (_crd && BasePopup === void 0 ? (_reportPossibleCrUseOfBasePopup({
        error: Error()
      }), BasePopup) : BasePopup) {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "btnOpen", _descriptor8, this);

          _initializerDefineProperty(this, "nodeOpen", _descriptor9, this);

          _initializerDefineProperty(this, "nodeOpen_Opacity", _descriptor10, this);
          ...
          _defineProperty(this, "groupRewardDataInfo", null);
        }
        ...
        showTubeRaceWinPopup(_indexRank) {
          ...
          this.groupRewardDataInfo = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          }), localConfig) : localConfig).instance.arrRace_GroupRewardDataInfos[_indexRank];
        ...
        setBoxReward_Appear() {
          ...
          var strAnimAppear = this.getAnimation_Appear_byIndexRank(this.indexRank + 1);
        ...
        setBoxReward_Touch() {
          var strAnimTouch = this.getAnimation_Touch_byIndexRank(this.indexRank + 1);
          ...
          tween(this.nodeOpen_Opacity).to(0.4, {
            opacity: 255
          }, {
            easing: 'quadOut',
            onComplete: () => {}
        ...
        touchOpen() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("open", "tuberacewinpopup");
          var timeDelay = 0.1;
          this.btnOpen.node.active = false;
          var strAnimOpening = this.getAnimation_Opening_byIndexRank(this.indexRank + 1);
          this.scheduleOnce(() => {
            this.chestBox.setAnimation(0, strAnimOpening, false);
          }, timeDelay);
          this.scheduleOnce(() => {
            tween(this.chestBox.node).to(0.3, {
              position: new Vec3(0, -430, 0)
            }, {
              easing: 'quadOut',
              onComplete: () => {}
            }).start();
        ...
        setBoxReward_Opened() {
          var strAnimOpened = this.getAnimation_Opened_byIndexRank(this.indexRank + 1);
        ...
        showRewards() {
          ...
          for (var i = 0; i < this.groupRewardDataInfo.items.length; i++) {
            var item = instantiate(this.getItemRewardReceivePrefab(this.groupRewardDataInfo.items[i].itemShopType));
            item.parent = this.nodeGroupContent;
            var posX = (i - this.groupRewardDataInfo.items.length / 2 + 0.5) * 350;
            item.setPosition(new Vec3(posX, 0, 0));
            var itemRewardReceive = item.getComponent(_crd && ItemRewardReceive === void 0 ? (_reportPossibleCrUseOfItemRewardReceive({
              error: Error()
        ...
        touchClaim() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("claim", "tuberacewinpopup");
          (_crd && AudioManager2 === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          ...
          for (var i = 0; i < this.groupRewardDataInfo.items.length; i++) {
            if (this.groupRewardDataInfo.items[i].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              ...
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("currency", "coin", this.groupRewardDataInfo.items[i].value, "race", "reward");
            } else if (this.groupRewardDataInfo.items[i].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).BOOSTER_UNDO) {
              ...
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "undo", this.groupRewardDataInfo.items[i].value, "race", "reward");
            } else if (this.groupRewardDataInfo.items[i].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).BOOSTER_SUGGEST) {
              (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "shuffle", this.groupRewardDataInfo.items[i].value, "race", "reward");
            } else if (this.groupRewardDataInfo.items[i].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).BOOSTER_ADDCOL) {
              (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "addcol", this.groupRewardDataInfo.items[i].value, "race", "reward");
            } else if (this.groupRewardDataInfo.items[i].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).HEART_UNLIMITED) {
              (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
              ...
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "heart_unlimited", this.groupRewardDataInfo.items[i].value, "race", "reward");
            }
          }
          ...
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constants) : Constants).TUBERACE_CLAIM_FINISHED);
          this.hidePopup();
        }

        getAnimation_Appear_byIndexRank(indexRank) {
          var strAnim = "appear";
        ...
        getAnimation_Touch_byIndexRank(indexRank) {
          var strAnim = "touch_to_open";
        ...
        getAnimation_Opening_byIndexRank(indexRank) {
          var strAnim = "opening";
        ...
        getAnimation_Opened_byIndexRank(indexRank) {
          var strAnim = "opened";
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "btnOpen", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "nodeOpen", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "nodeOpen_Opacity", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=TubeRaceWinPopup.js.map