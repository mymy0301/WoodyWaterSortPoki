System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Button, Component, clientEvent, Constants, SHOP_PACK_TYPE, FBInstantManager, localConfig, _dec, _dec2, _class, _class2, _descriptor, _temp, _crd, ccclass, property, ButtonSaleManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ec76c2QRJdBYamxsHROEzBW", "ButtonSaleManager", undefined);
      ...
      _export("ButtonSaleManager", ButtonSaleManager = (_dec = ccclass('ButtonSaleManager'), _dec2 = property(Button), _dec(_class = (_class2 = (_temp = class ButtonSaleManager extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "btnSale", _descriptor, this);
        }
        ...
        showInfo() {
          if ((_crd && FBInstantManager === void 0 ? (_reportPossibleCrUseOfFBInstantManager({
            ...
            error: Error()
          }), SHOP_PACK_TYPE) : SHOP_PACK_TYPE).SUMMER_PACK))) {
        ...
        touchSale() {
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            ...
            error: Error()
          }), Constants) : Constants).SHOW_SUMMER_PACK_POPUP);
        }

      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "btnSale", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
...
//# sourceMappingURL=ButtonSaleManager.js.map