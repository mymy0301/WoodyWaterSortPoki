System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Button, BasePopup, Constants, GAME_STATE, localConfig, clientEvent, LogEventManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _temp, _crd, ccclass, property, QuitConfirmPopup;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "8912fhi3QJM1KJQp1T95u6K", "QuitConfirmPopup", undefined);
      ...
      _export("QuitConfirmPopup", QuitConfirmPopup = (_dec = ccclass('QuitConfirmPopup'), _dec2 = property(Button), _dec3 = property(Button), _dec(_class = (_class2 = (_temp = class QuitConfirmPopup extends (_crd && BasePopup === void 0 ? (_reportPossibleCrUseOfBasePopup({
        error: Error()
      }), BasePopup) : BasePopup) {
        constructor() {
          super(...arguments);
        ...
        touchContinue() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("continue", "quitconfirm");
          super.hidePopup();
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            error: Error()
          }), clientEvent) : clientEvent).dispatchEvent((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).QUITCONFIRM_TOUCH_CONTINUE);
        }

        touchClose() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("close", "quitconfirm");
          super.touchClose();
          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            error: Error()
          }), clientEvent) : clientEvent).dispatchEvent((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
...
//# sourceMappingURL=QuitConfirmPopup.js.map