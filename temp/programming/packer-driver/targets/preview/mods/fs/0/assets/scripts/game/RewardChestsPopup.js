    ...
    execute: function () {
      ...
      _export("RewardChestsPopup", RewardChestsPopup = (_dec = ccclass('RewardChestsPopup'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Label), _dec7 = property(Node), _dec8 = property(UIOpacity), _dec9 = property(Node), _dec10 = property(Button), _dec11 = property(Node), _dec12 = property(UIOpacity), _dec(_class = (_class2 = (_temp = class RewardChestsPopup extends (_crd && BasePopup === void 0 ? (_reportPossibleCrUseOfBasePopup({
        ...
        setClaimRewards(isX2) {
          ...
          for (var i = 0; i < this.arrItemRewardReceives.length; i++) {
            this.arrItemRewardReceives[i].hideItem();
          }

          if (isX2) {
            for (var _i = 0; _i < this.groupRewardDataInfo.items.length; _i++) {
              this.groupRewardDataInfo.items[_i].value *= 2;
            }
          }

          for (var _i2 = 0; _i2 < this.groupRewardDataInfo.items.length; _i2++) {
            if (this.groupRewardDataInfo.items[_i2].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).COIN) {
              (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
                error: Error()
                ...
                error: Error()
              }), Constants) : Constants).SHOW_ADDCOIN, this.groupRewardDataInfo.items[_i2].value);
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("currency", "coin", this.groupRewardDataInfo.items[_i2].value, "level_chests", "reward");
            } else if (this.groupRewardDataInfo.items[_i2].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).BOOSTER_UNDO) {
              (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                ...
                error: Error()
              }), BOOSTER_TYPE) : BOOSTER_TYPE).UNDO) + this.groupRewardDataInfo.items[_i2].value);
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "undo", this.groupRewardDataInfo.items[_i2].value, "level_chests", "reward");
            } else if (this.groupRewardDataInfo.items[_i2].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).BOOSTER_SUGGEST) {
              (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                ...
                error: Error()
              }), BOOSTER_TYPE) : BOOSTER_TYPE).SUGGEST) + this.groupRewardDataInfo.items[_i2].value);
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "shuffle", this.groupRewardDataInfo.items[_i2].value, "level_chests", "reward");
            } else if (this.groupRewardDataInfo.items[_i2].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).BOOSTER_ADDCOL) {
              (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                ...
                error: Error()
              }), BOOSTER_TYPE) : BOOSTER_TYPE).ADDCOL) + this.groupRewardDataInfo.items[_i2].value);
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "addcol", this.groupRewardDataInfo.items[_i2].value, "level_chests", "reward");
            } else if (this.groupRewardDataInfo.items[_i2].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).HEART_UNLIMITED) {
              (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
                ...
                error: Error()
              }), Constants) : Constants).SHOW_ADDHEART_UNLIMITED, this.groupRewardDataInfo.items[_i2].value);
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "heart_unlimited", this.groupRewardDataInfo.items[_i2].value, "level_chests", "reward");
            }
          }
