System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f1a2767dGJLaJBSRBE6gebT", "WinPopup", undefined);
      ...
      _export("WinPopup", WinPopup = (_dec = ccclass('WinPopup'), _dec2 = property(Widget), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(UIOpacity), _dec6 = property(sp.Skeleton), _dec7 = property(Node), _dec8 = property(UIOpacity), _dec(_class = (_class2 = (_temp = class WinPopup extends (_crd && BasePopup === void 0 ? (_reportPossibleCrUseOfBasePopup({
        ...
        showPoup_ShowView_Finished() {
          ...
          var strAnimation_Appear = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
        ...
        setCharacter_Appear_Finished() {
          var strAnimation_Dance = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
        ...
        showButton_Step2() {
          ...
          tween(this.btnContinue.node).to(0.3, {
            scale: new Vec3(1, 1, 1)
          }, {
            easing: 'backOut'
          }).start();
          tween(this.nodeContinue_Opacity).to(0.3, {
            opacity: 255
          }, {
            easing: 'quadOut',
        ...
        showWinPopup_DailyChallenge() {
          ...
          this.txtLevel.string = "" + (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
        ...
        touchShare() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("share", "winpopup");
        ...
        touchContinue() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("continue", "winpopup");
          this.hidePopup(); // console.log("currGameMode",localConfig.instance.currGameMode,"currLevelUnlock",localConfig.instance.currLevelUnlock);
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
                ...
                error: Error()
              }), Constants) : Constants).TOUCH_NEXT_LEVEL);
            } else {
              (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
                error: Error()
              }), clientEvent) : clientEvent).dispatchEvent((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              }), Constants) : Constants).SHOW_LEVELCHEST_POPUP);
            }
            ...
            (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
              ...
              error: Error()
            }), Constants) : Constants).DAILYCHALLENGE_LEVEL_FINISHED);
          }
        }
        ...
        touchClose() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("close", "winpopup");
          super.touchClose();
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
              ...
              error: Error()
            }), Constants) : Constants).WINPOPUP_TOUCH_HOME, rewardCoin);
          } else if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          }), localConfig) : localConfig).instance.currGameMode == (_crd && GAME_MODE === void 0 ? (_reportPossibleCrUseOfGAME_MODE({
            error: Error()
        ...
        writable: true,
        initializer: null
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "txtLevel", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
