      ...
      _export("FBInstantManager", FBInstantManager = (_dec = ccclass('FBInstantManager'), _dec(_class = (_temp = _class2 = class FBInstantManager extends Component {
        ...
        onLoad() {
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            var myTestPhoto = "https://i.imgur.com/MhuKnur.png";
        ...
        InitFBInstant_Finished() {
          ...
          if (entryPointData != null) {
            try {
              var entryPointDataPayLoad = JSON.parse(entryPointData);
              var campID = entryPointDataPayLoad.fb_instant_game_campaign_id;
              ...
              var adsetID = entryPointDataPayLoad.fb_instant_game_adset_id;
              ...
              var ads = entryPointDataPayLoad.fb_instant_game_ad_id;
              ...
              if ((_crd && lodash === void 0 ? (_reportPossibleCrUseOflodash({
                ...
                var _campID = entryPointData.fb_instant_game_campaign_id;

                if (_campID) {
                  (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                    error: Error()
                  }), localConfig) : localConfig).instance.campID_session = _campID;
                }

                var _adsetID = entryPointData.fb_instant_game_adset_id;

                if (_adsetID) {
                  (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                    error: Error()
                  }), localConfig) : localConfig).instance.adsetID_session = _adsetID;
                }

                var _ads = entryPointData.fb_instant_game_ad_id;

                if (_ads) {
                  (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                    error: Error()
                  }), localConfig) : localConfig).instance.adsID_session = _ads;
                }
              }
            }
        ...
        Preload_InterstitialAdAsync() {
          ...
          var startTimeLoadInterstitial = new Date().getTime();
          FBInstant.getInterstitialAdAsync((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            ...
            var endTimeLoadInterstitial = new Date().getTime();
            (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
              error: Error()
        ...
        Preload_RewardAdAsync() {
          ...
          var startTimeLoadRewardVideo = new Date().getTime();
          FBInstant.getRewardedVideoAsync((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            ...
            var endTimeLoadRewardVideo = new Date().getTime();
            (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
              error: Error()
            }), LogEventManager) : LogEventManager).instance.logAdRequest((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
        ...
        Load_BannerAdAsync() {
          ...
          var strartTimeLoadBanner = new Date().getTime();
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          ...
          FBInstant.loadBannerAdAsync((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            ...
            var endTimeLoadBanner = new Date().getTime();
            (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
              error: Error()
        ...
        Load_Ad_SheduleOne() {
          var self = this; // this.SetNextTime_ShowInterstitialAd();
        ...
        setStartGame() {
          var self = this; ////console.log("setStartGame");
        ...
        getTournament() {
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            FBInstant.getTournamentAsync().then(tournament => {
              ...
              var tournamentPayLoad = tournament.getPayload();
              console.log(tournamentPayLoad);

              if (tournamentPayLoad && tournamentPayLoad.length > 0) {
                var payloadData = JSON.parse(tournament.getPayload());
        ...
        getTournament_AfterJoinTournament(cb) {
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            FBInstant.getTournamentAsync().then(tournament => {
              ...
              var tournamentPayLoad = tournament.getPayload(); // console.log("tournamentPayLoad",tournamentPayLoad);
        ...
        createTournament(score, cb) {
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            FBInstant.tournament.createAsync(createTournamentPayload).then(tournament => {
              ...
              var id = tournament.getID(); // console.log(id);
            ...
            if (FBInstant.context && FBInstant.context.getID()) {
              FBInstant.getLeaderboardAsync('score.' + FBInstant.context.getID()).then(leaderboard => leaderboard.getEntriesAsync(100, 0)).then(entries => {
                ...
                for (var i = 0; i < entries.length; i++) {
                  ...
                  _itemRankInfo.userName = entries[i].getPlayer().getName();
                  _itemRankInfo.avatarType = (_crd && AVATAR_TYPE === void 0 ? (_reportPossibleCrUseOfAVATAR_TYPE({
                    error: Error()
                  }), AVATAR_TYPE) : AVATAR_TYPE).TYPE_WEB;
                  _itemRankInfo.userScore = entries[i].getScore();
                  _itemRankInfo.avatarURL = entries[i].getPlayer().getPhoto();
                  _itemRankInfo.indexRank = entries[i].getRank();
                  _itemRankInfo.isMyRank = entries[i].getPlayer().getID() == (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                    error: Error()
                  }), localConfig) : localConfig).instance.playerID;
                  _itemRankInfo.idFB = entries[i].getPlayer().getID();
                  arrListLeaderboard_Ranks.push(_itemRankInfo);
                }
        ...
        PlayWithFriend(cb) {
          var self = this; // console.log("PlayWithFriendPlayWithFriendPlayWithFriend");
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              var id = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                error: Error()
        ...
        UpdateContext_WithFriend(base64Picture, withFriendDataInfo, cb) {
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            var withfriendData = JSON.stringify(withFriendDataInfo); // console.log("UpdateContext_WithFriend",withfriendData);
          ...
          if ((_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            ...
            FBInstant.player.getConnectedPlayersAsync().then(connectedPlayers => {
              ...
              for (var i = 0; i < connectedPlayers.length; i++) {
                var connectedPlayer = connectedPlayers[i]; //console.log(connectedPlayer.getPhoto());

                var friendInfo = new (_crd && FriendAvatarInfo === void 0 ? (_reportPossibleCrUseOfFriendAvatarInfo({
                  error: Error()
            ...
            if (FBInstant.context && FBInstant.context.getID()) {
              FBInstant.getLeaderboardAsync('score.' + FBInstant.context.getID()).then(leaderboard => leaderboard.getEntriesAsync(100, 0)).then(entries => {
                ...
                for (var i = 0; i < entries.length; i++) {
                  ...
                  //     entries[i].getScore()
                  // );
                  var _itemRankInfo2 = new (_crd && ItemRankInfo === void 0 ? (_reportPossibleCrUseOfItemRankInfo({
                    error: Error()
                  }), ItemRankInfo) : ItemRankInfo)();

                  _itemRankInfo2.userName = entries[i].getPlayer().getName();
                  _itemRankInfo2.avatarType = (_crd && AVATAR_TYPE === void 0 ? (_reportPossibleCrUseOfAVATAR_TYPE({
                    error: Error()
                  }), AVATAR_TYPE) : AVATAR_TYPE).TYPE_WEB;
                  _itemRankInfo2.userScore = entries[i].getScore();
                  _itemRankInfo2.avatarURL = entries[i].getPlayer().getPhoto();
                  _itemRankInfo2.indexRank = entries[i].getRank();
                  _itemRankInfo2.isMyRank = entries[i].getPlayer().getID() == (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
                    error: Error()
                  }), localConfig) : localConfig).instance.playerID;
                  _itemRankInfo2.idFB = entries[i].getPlayer().getID();
                  arrListLeaderboard_Ranks.push(_itemRankInfo2);
                }
        ...
        sendA2U(data) {
          ...
          var path = "https://game3f.com:8000/webhook";
        ...
        sendNewA2U(asid) {
          ...
          for (var i = 0; i < DAYS.length; i++) {
            ...
            var messageData = (_crd && A2uData === void 0 ? (_reportPossibleCrUseOfA2uData({
              error: Error()
        ...
        getIAP_AllPack() {
          ...
          FBInstant.payments.getCatalogAsync().then(products => {
            ...
            for (var i = 0; i < products.length; i++) {
              ...
              var catalogInfo = new CatalogInfo(productID, price); // console.log(productID);
              // console.log(price);
        ...
        checkHaveIAPPack_byProductID(packID) {
          ...
          for (var i = 0; i < FBInstantManager.instance.arrCatalogInfos.length; i++) {
        ...
        buyIAP_consumePackID(packID, placement, shop_type, cb) {
          ...
          FBInstant.payments.purchaseAsync({
            ...
            var valueIAP = (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              error: Error()
        ...
        iap_checkPurchaseInfo(packID) {
          for (var i = 0; i < FBInstantManager.instance.arrPurchaseInfos.length; i++) {
        ...
        getListIAP_Purchase(cb) {
          ...
          FBInstant.payments.getPurchasesAsync().then(function (purchases) {
            for (var i = 0; i < purchases.length; i++) {
              var productID = purchases[i].productID;
              var purchaseToken = purchases[i].purchaseToken;
              var purchaseInfo = new PurchaseInfo(productID, purchaseToken);
        ...
        getAllCatalogs() {
          ...
          FBInstant.graphApi.requestAsync("/app/products?fields=id,product_id,name,price,price_amount_cents", "GET").then(result => {
            ...
            for (var i = 0; i < products.length; i++) {
              ...
              var price = products[i].price;
              var price_amount_cents = products[i].price_amount_cents;
              var catalogInfo = new CatalogInfo(productID, price); // console.log(productID);
              // console.log(price);
