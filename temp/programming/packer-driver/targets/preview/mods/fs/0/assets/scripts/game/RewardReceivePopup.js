System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Button, instantiate, Label, Node, Prefab, tween, UIOpacity, Vec3, BasePopup, BOOSTER_TYPE, Constants, SHOP_ITEM_TYPE, clientEvent, ItemRewardReceive, AudioManager2, localConfig, LogEventManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _temp, _crd, ccclass, property, RewardReceivePopup;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "38e0flfd+pCDLHYaaJdHVF6", "RewardReceivePopup", undefined);
      ...
      _export("RewardReceivePopup", RewardReceivePopup = (_dec = ccclass('RewardReceivePopup'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Button), _dec6 = property(Node), _dec7 = property(UIOpacity), _dec(_class = (_class2 = (_temp = class RewardReceivePopup extends (_crd && BasePopup === void 0 ? (_reportPossibleCrUseOfBasePopup({
        error: Error()
      }), BasePopup) : BasePopup) {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "nodeClaim", _descriptor5, this);

          _initializerDefineProperty(this, "nodeClaim_Opacity", _descriptor6, this);
        ...
        touchClaim() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("claim", "rewardreceivepopup");
          (_crd && AudioManager2 === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          ...
          for (var i = 0; i < this.groupRewardDataInfo.items.length; i++) {
            if (this.groupRewardDataInfo.items[i].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              ...
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("currency", "coin", this.groupRewardDataInfo.items[i].value, this.title.toLowerCase().toString(), "reward");
            } else if (this.groupRewardDataInfo.items[i].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).BOOSTER_UNDO) {
              ...
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "undo", this.groupRewardDataInfo.items[i].value, this.title.toLowerCase().toString(), "reward");
            } else if (this.groupRewardDataInfo.items[i].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).BOOSTER_SUGGEST) {
              (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "shuffle", this.groupRewardDataInfo.items[i].value, this.title.toLowerCase().toString(), "reward");
            } else if (this.groupRewardDataInfo.items[i].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).BOOSTER_ADDCOL) {
              (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
              ...
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "addcol", this.groupRewardDataInfo.items[i].value, this.title.toLowerCase().toString(), "reward");
            } else if (this.groupRewardDataInfo.items[i].itemShopType == (_crd && SHOP_ITEM_TYPE === void 0 ? (_reportPossibleCrUseOfSHOP_ITEM_TYPE({
              error: Error()
            }), SHOP_ITEM_TYPE) : SHOP_ITEM_TYPE).HEART_UNLIMITED) {
              (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
              ...
              (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
                error: Error()
              }), LogEventManager) : LogEventManager).instance.logResourceEarned("booster", "heart_unlimited", this.groupRewardDataInfo.items[i].value, this.title.toLowerCase().toString(), "reward");
            }
          }
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "nodeClaim", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "nodeClaim_Opacity", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=RewardReceivePopup.js.map