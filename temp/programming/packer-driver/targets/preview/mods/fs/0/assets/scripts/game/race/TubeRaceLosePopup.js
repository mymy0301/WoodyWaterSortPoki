System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Button, Label, BasePopup, Constants, clientEvent, AudioManager2, LogEventManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _temp, _crd, ccclass, property, TubeRaceLosePopup;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "6cb91sp6H5CXYuvhLZWjT2t", "TubeRaceLosePopup", undefined);
      ...
      _export("TubeRaceLosePopup", TubeRaceLosePopup = (_dec = ccclass('TubeRaceLosePopup'), _dec2 = property(Button), _dec3 = property(Label), _dec(_class = (_class2 = (_temp = class TubeRaceLosePopup extends (_crd && BasePopup === void 0 ? (_reportPossibleCrUseOfBasePopup({
        error: Error()
      }), BasePopup) : BasePopup) {
        constructor() {
          super(...arguments);
          ...
          _defineProperty(this, "indexRank", 5);
        }
        ...
        showTubeRaceLosePopup(_indexRank) {
        ...
        touchContinue() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("continue", "tuberacelosepopup");
          this.hidePopup();
          (_crd && AudioManager2 === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager2) : AudioManager2).instance.playPopupOpen2();
...
//# sourceMappingURL=TubeRaceLosePopup.js.map