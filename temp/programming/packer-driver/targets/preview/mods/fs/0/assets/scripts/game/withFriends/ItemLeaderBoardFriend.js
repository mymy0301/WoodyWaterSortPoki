System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Button, Color, Component, Label, Node, Sprite, SpriteFrame, tween, UIOpacity, Vec3, FBInstantManager, Utils, localConfig, AVATAR_TYPE, Constants, resourceUtil, clientEvent, LogEventManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _temp, _crd, ccclass, property, ItemLeaderBoardFriend;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "be7fabKGuBH77Qp9Q/LDJuI", "ItemLeaderBoardFriend", undefined);
       ...
       * Name = ItemLeaderBoardFriend
       * DateTime = Fri Mar 21 2025 14:45:54 GMT+0700 (Indochina Time)
       * Author = MoonMoon246
       * FileBasename = ItemLeaderBoardFriend.ts
       * FileBasenameNoExtension = ItemLeaderBoardFriend
       * URL = db://assets/scripts/game/withFriends/ItemLeaderBoardFriend.ts
       * ManualUrl = https://docs.cocos.com/creator/3.4/manual/en/
       *
       */

      _export("ItemLeaderBoardFriend", ItemLeaderBoardFriend = (_dec = ccclass('ItemLeaderBoardFriend'), _dec2 = property(Node), _dec3 = property(UIOpacity), _dec4 = property(Sprite), _dec5 = property(SpriteFrame), _dec6 = property(Sprite), _dec7 = property(SpriteFrame), _dec8 = property(Sprite), _dec9 = property(SpriteFrame), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Button), _dec(_class = (_class2 = (_temp = class ItemLeaderBoardFriend extends Component {
        constructor() {
          super(...arguments);
        ...
        init(_itemRankInfo, _timeDelay) {
          ...
          this.txtScore.string = "Lv." + (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
        ...
        touchPlay() {
          (_crd && LogEventManager === void 0 ? (_reportPossibleCrUseOfLogEventManager({
            error: Error()
          }), LogEventManager) : LogEventManager).instance.logButtonClick("play", "friendspopup"); // console.log("touchPlay",this.itemRankInfo);

          (_crd && clientEvent === void 0 ? (_reportPossibleCrUseOfclientEvent({
            error: Error()
          }), clientEvent) : clientEvent).dispatchEvent((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).WITHFRIEND_TOUCH_PLAY, this.itemRankInfo);
        }
...
//# sourceMappingURL=ItemLeaderBoardFriend.js.map