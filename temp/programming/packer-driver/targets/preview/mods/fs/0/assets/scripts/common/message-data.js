    ...
    execute: function () {
      ...
      _export("A2uData", A2uData = class A2uData {
        static a2uNotification(delayTime) {
          var _elements = [];
          var page = DAILY_MESSAGE.dataDaily;
          var length = page.length;

          var _index = Math.floor(Math.random() * length);

          var _data = page[_index];
          var buttonDatas = _data.buttons;
          var buttons = [];

          for (var buttonData of buttonDatas) {
