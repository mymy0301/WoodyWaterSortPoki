...
declare namespace FBInstant {
    ...
    function loadBannerAdAsync(placementID: string): Promise<AdInstance>;
    
    function hideBannerAdAsync():Promise<AdInstance>;
    /**
     ...
     * @returns void
     */
    function postSessionScoreAsync(score: number): void;
    ...
    interface Context {
        ...
        inviteAsync(options?: ContextOptions): Promise<void>;
