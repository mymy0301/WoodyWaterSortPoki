...
@ccclass('ItemLeaderBoardFriend')
export class ItemLeaderBoardFriend extends Component {
    // [1]
    // dummy = '';
    ...
    init(_itemRankInfo:ItemRankInfo,_timeDelay:number = 0){
        ...
        this.txtScore.string = `Lv.${Utils.formatNumber(this.itemRankInfo.userScore)}`;
    ...
    touchPlay(){
        LogEventManager.instance.logButtonClick("play","friendspopup");
        // console.log("touchPlay",this.itemRankInfo);
        clientEvent.dispatchEvent(Constants.WITHFRIEND_TOUCH_PLAY,this.itemRankInfo);
    }
}
